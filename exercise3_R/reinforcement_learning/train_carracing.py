...
def run_episode(env, agent, deterministic, skip_frames=2,  do_training=True, rendering=True, max_timesteps=1000, history_length=0):
    ...
    while True:
        ...
        action_id = agent.act(state=state, deterministic=deterministic, p=[0.3, 0.15, 0.15, 0.25, 0.15])
...
if __name__ == "__main__":
    ...
    agent = DQNAgent(Q, Q_target, num_actions, gamma=0.7, batch_size=32, epsilon=0.2, tau=0.01, lr=1e-4)
