...
def run_episode(env, agent, deterministic, skip_frames=5,  do_training=True, rendering=True, max_timesteps=1000, history_length=0):
    ...
    while True:
        ...
        action_id = agent.act(state=state, deterministic=deterministic, p=[0.04, 0.1, 0.1, 0.05, 0.35])
...
if __name__ == "__main__":
    ...
    agent = DQNAgent(Q, Q_target, num_actions, gamma=0.8, batch_size=64, epsilon=0.5, tau=0.01, lr=1e-4)
